...
import com.epam.training.gen.ai.service.plugins.AgeCalculatorPlugin;
import com.epam.training.gen.ai.service.plugins.LightsPlugin;
...
public class SemanticKernelConfiguration {
    ...
    public Kernel kernel(ChatCompletionService chatCompletionService) {
        KernelPlugin agePlugin = KernelPluginFactory.createFromObject(
            new AgeCalculatorPlugin(), "AgeCalculatorPlugin");
        KernelPlugin lightPlugin = KernelPluginFactory.createFromObject(
            new LightsPlugin(),
            "LightsPlugin"
        );
