...
public class SimpleVectorService {
    ...
    /**
     * Splits the text into sentences and processes splits into embeddings,
     * transforms them into vector points,
    ...
    public void processAndSaveText(String text) {
        var sentences = documentSplitter.splitIntoSentences(text);
        ...
        sentences.forEach(sentence -> {
            ...
            embeddings.forEach(
                embeddingItem -> {
                    ...
                    var pointStruct = getPointStruct(values, sentence);
