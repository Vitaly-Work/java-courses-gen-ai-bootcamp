...
import com.epam.training.gen.ai.service.plugins.DocumentRetrievalPlugin;
...
public class SemanticKernelConfiguration {
    ...
    public Kernel kernel(ChatCompletionService chatCompletionService,
        ...
        KernelPlugin documentRetrievalPlugin = KernelPluginFactory.createFromObject(
            new DocumentRetrievalPlugin(simpleDocumentService), "DocumentRetrievalPlugin");

        return Kernel.builder()
            .withAIService(ChatCompletionService.class, chatCompletionService)
            .withPlugin(documentRetrievalPlugin)
            .build();
    }
