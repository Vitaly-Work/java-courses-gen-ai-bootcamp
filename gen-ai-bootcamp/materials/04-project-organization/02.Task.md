...
Open the "Lab4" project located in the `dotnet/labs/lab4` folder of your course materials. This project contains the initial setup required for this task, including the necessary project configuration and dependencies.
...
Review the custom plugin - AgeCalculatorPlugin code from the `plugin` folder.
