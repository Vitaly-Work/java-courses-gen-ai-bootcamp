...
== Cleanup
1. Make sure that both streaming jobs (`readFromEventHub.py` and `writeToOutboundEventHub.py`) are **stopped manually**, otherwise they will keep running indefinitely.
