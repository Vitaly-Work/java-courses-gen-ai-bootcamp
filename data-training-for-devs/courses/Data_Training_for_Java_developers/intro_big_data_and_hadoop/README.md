...
-   [[data warehouse vs lake vs
    mart]](https://medium.com/codex/data-warehouse-vs-data-mart-vs-data-lake-a335f328e6a8)

-   [[ETL vs
    ELT]](https://www.mssqltips.com/sqlservertip/5937/etl-vs-elt-features-and-use-cases/)
...
-   then, a [[Lambda or Kappa
    architecture]](https://nexocode.com/blog/posts/lambda-vs-kappa-architecture/)
...
[[data products]](https://lakefs.io/blog/data-products/) per
department and organise them.

Data products on a large scale are typically organised using the [[data
mesh architecture]](https://www.datamesh-architecture.com/)
